...
public class GeneticAlgorithm
{
    ...
    private static ArrayList<Chromosome> reference_fitness = new ArrayList(Constants.POPULATION_SIZE);
    ...
    private static void Initialize_Reference_Fitness()
    {
        reference_fitness.add(e)
    }
